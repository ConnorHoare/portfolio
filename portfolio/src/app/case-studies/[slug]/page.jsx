...
const page = () => {
  ...
  return (
    <div>
      ...
      <div className='flex bg-grey-6 justify-around p-10 dark:bg-grey-5'>
      ...
      <div className='flex justify-center bg-grey-6 dark:bg-grey-5'>
        <div className='space-y-5 py-24 px-48 text-4xl text-blue-2 dark:text-grey-3'>
          <p>
      ...
      <div className='flex flex-col w-full py-24 px-24'>
        ...
        <div className='flex flex-row justify-around '>
          <div className='flex-col space-y-4'>
            ...
            <p className='text-center font-bold dark:text-white'>Definition</p>
          </div>
          <div className='flex-col space-y-4'>
            {isDark ? (
            ...
            <p className='text-center font-bold dark:text-white'>Planning</p>
          </div>
          <div className='flex-col space-y-4'>
            {isDark ? (
            ...
            <p className='text-center font-bold dark:text-white'>Development</p>
          </div>
          <div className='flex-col space-y-4'>
            {isDark ? (
            ...
            <p className='text-center font-bold dark:text-white'>Delivery</p>
          </div>
        </div>
      </div>
      ...
      <div className='flex justify-around items-center bg-grey-6 dark:bg-grey-5 py-12'>
        <div className='flex flex-col w-full'>
          <div className='text-left w-full self-start px-36'><p className=' text-sm font-bold text-blue-1 dark:text-blue-4'>IMAGES</p></div>
          <div className='text-left w-full px-36'><p className=' text-4xl font-bold dark:text-white'>Product</p></div>
      ...
      <div className='flex justify-around items-center py-12 dark:bg-black-1'>
        <div className='flex flex-col w-full'>
          <div className='text-left w-full self-start px-36'><p className=' text-sm font-bold text-blue-1 dark:text-blue-4'>LEARNINGS & CHALLENGES</p></div>
          <div className='text-left w-full px-36'><p className=' text-4xl font-bold dark:text-white'>Takeaways</p></div>

          <div className='mt-12 flex flex-col bg-grey-6 rounded mx-36 p-12 space-y-4 dark:bg-grey-5'>
      ...
      <div className='flex justify-around items-center py-12 dark:bg-grey-5'>
        <div className='flex flex-col w-full'>
          <div className='text-left w-full self-start px-36'><p className=' text-sm font-bold text-blue-1 dark:text-blue-4'>PROJECTS</p></div>
          ...
          <div className='flex flex-row justify-between px-36 py-8'>
            ...
            <div className="max-w-sm rounded overflow-hidden shadow-lg bg-white flex flex-col dark:bg-grey-7 pb-4">
